 ...
 */
export const LLM_EXPLORE_HIRING_COMPANIES_MODEL = ['ollama-plugin/qwen3.6:35b'];
 ...
 * file.
 */
export const LLM_RESEARCH_COMPANY_MODEL = ['ollama-plugin/qwen3.6:35b'];
 ...
 *
 */
export const LLM_IDENTIFY_JOB_LIST_URL_MODEL = ['ollama-plugin/qwen3.6:35b'];
 ...
 */
export const LLM_CODING_MODEL = ['ollama-plugin/qwen3.6:35b'];
 ...
 * - low output cost
 */
export const LLM_VIEW_JOB_DETAIL_MODEL = ['ollama-plugin/qwen3.6:35b'];
 ...
 * - low input cost
 */
export const LLM_EVALUATION_MODEL = ['ollama-plugin/qwen3.6:35b'];
 ...
 */
export const LLM_CV_TEMPLATE_MODEL = ['ollama-plugin/qwen3.6:35b'];
