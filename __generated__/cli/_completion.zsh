# Zsh completion for jobfinder. Generated by "jobfinder completion zsh".
# Install: source <(jobfinder completion zsh)
...
_jobfinder() {
  ...
  _arguments -C \
    '1:subcommand:(scrape sites completion help-menu-dump)' \
    '*:: :->args'
  ...
  case $state in
    ...
    sites) _normal ;;
    completion) _jobfinder_completion ;;
